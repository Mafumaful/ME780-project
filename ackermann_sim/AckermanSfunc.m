function [sys, x0, str, ts, simStateCompliance] = sfuntmpl(t, x, u, flag, wheel_base, wheel_track, initial_state)
    ...
    switch flag,
            ...
            %%%%%%%%%%%%%%%%%%
        case 0,
            [sys, x0, str, ts, simStateCompliance] = mdlInitializeSizes(wheel_base, wheel_track, initial_state);

            %%%%%%%%%%%%%%%
            % Derivatives %
            %%%%%%%%%%%%%%%
        case 1,
            sys = mdlDerivatives(t, x, u, wheel_base);
    ...
    %=============================================================================
    %
    function [sys, x0, str, ts, simStateCompliance] = mdlInitializeSizes(wheel_base, wheel_track, initial_state)
        ...
        %=============================================================================
        %
        function sys = mdlDerivatives(t, x, u, wheel_base)
            ...
            x_dot = calc_increment(u(1), u(2), x(3), x(4));
            sys = full(x_dot);
